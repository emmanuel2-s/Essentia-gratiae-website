...
// import bg from "../assets/images/candle-guidiance.jpeg";
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <p className="mt-6 max-w-xl text-[#6f6358] leading-8">
              Every ritual begins with intention. Review your selected
              essentials before continuing to checkout.
            </p>
          </motion.div>
            ...
            >
              <div className="sticky top-36 rounded-3xl bg-white p-10 shadow">
                ...
                <div className="flex justify-between text-3xl">
                  ...
                  <span className="text-[#7d8770]">£{total}</span>
                </div>
